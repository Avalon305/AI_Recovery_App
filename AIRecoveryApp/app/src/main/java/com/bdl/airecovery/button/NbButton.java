package com.bdl.airecovery.button;
...
public class NbButton extends android.support.v7.widget.AppCompatButton {
    ...
    private void init(Context context) {
        ...
        backDrawable.setColor(getResources().getColor(R.color.grey6));
    ...
    public void startAnim(ImageView imageView1, ImageView imageView2){
//        isMorphing=true;
