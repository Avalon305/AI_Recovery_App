...
*/
public class MyBallViewHeart extends View {
    ...
    * 通过Activity激活state状态*/
    ...
    public MyBallViewHeart(Context context, AttributeSet set) {
        super(context,set);
    ...
    * 如果当前速度/力量不再合理范围之内，将根据当前速度脱离椭圆轨道，向心或者离心*/
    ...
    public int translateLR()
    {
        if(this.currentX>=40)
        {
            ...
            /*打印实时坐标*/
            //Log.d(MyBallView.ACTIVITY_TAG, "currentX:"+currentX+"  currentY:"+currentY);
            this.invalidate();
            //angleX--;
            //angleY++;
        }
