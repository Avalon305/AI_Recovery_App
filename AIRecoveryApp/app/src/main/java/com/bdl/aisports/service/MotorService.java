...
import com.bdl.aisports.mao.MotorSocketClient;
...
import static com.bdl.aisports.contoller.Writer.setInitialBounce;
import static com.bdl.aisports.contoller.Writer.setKeepArmTorque;
                ...
                try {
                    ...
                    if (Integer.parseInt(currentPosition) <= position + 50000) { //比较当前位置和初始位置
                        ...
                        switch (deviceType) {
                            case 1: //拉设备
                                //初始化顺反向力
                                setParameter((int) ((double)positiveTorqueLimited * rate), MotorConstant.SET_POSITIVE_TORQUE_LIMITED);
                                setParameter((int) ((double)negativeTorqueLimited * rate), MotorConstant.SET_NEGATIVE_TORQUE_LIMITED);
